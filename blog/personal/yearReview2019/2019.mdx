...
<Gallery photos={[
   { src: wizardLunch, width: 527, height: 937 },
]} />
...
<Gallery photos={[
   { src: hike1, width: 1579, height: 888 },
   { src: hike2, width: 1666, height: 937 },
   { src: hike4, width: 600, height: 333 },
   { src: hike3, width: 1666, height: 937 },
   { src: hike5, width: 1920, height: 880 },
]} />
...
After many years, I have finally learned traditional dancing! I have learned [Khigga, Shekhani, and Gubbare](https://en.wikipedia.org/wiki/Assyrian_folk_dance). I am still not a pro yet, but at least I can hold my own and not have people give up dancing next to me. This was in preparation for my cousin's engagement party, which was a blast!


<Gallery photos={[
   { src: alvan1, width: 2016, height: 1512 },
   { src: alvan2, width: 2016, height: 1512 },
   { src: alvan3, width: 2016, height: 1512 },
   { src: alvan4, width: 2016, height: 1504 },
   { src: alvan5, width: 2016, height: 1504 },
   { src: alvan6, width: 2016, height: 1512 },
   { src: alvan7, width: 716, height: 960 },
   { src: alvan8, width: 2016, height: 1512 },
]} />
...
<Gallery photos={[
   ...
   { src: other34, width: 500, height: 888 },
   { src: other35, width: 364, height: 750 },
   { src: other36, width: 1184, height: 888 },
   { src: other37, width: 2016, height: 1134 },
   { src: other38, width: 1184, height: 888 },
]} />
...
<Gallery photos={[
   { src: weight, width: 604, height: 340 },
]} />
