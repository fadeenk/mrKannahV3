...
- **Create blog using gatsby**: After using medium for a while, I disliked it because it could not handle complex long posts. Additionally, with all the new pay walls they are adding I decided I could do it better so this is why I created [my blog](.//blog).
