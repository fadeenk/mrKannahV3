...
### December
The craziness did not die down, on the contrary things got more intense. The deadline for the massive release grew closer and closer, while we are still working on it. Additionally, I had to plan for end of the quarter as well as for next year.
...
// Hike images/video
Christmas was fun, spent it with the family, ate alot of food and got to relax. However, this time instead of working on another project, I decided to enjoy my time by playing a new game. I ended up playing a new korean mmorpg (Kritika:REBOOT), which brought back memories of me staying up super late playing games.
