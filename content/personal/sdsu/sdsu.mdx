...
It all started before even stepping into San Diego State University (SDSU). It started with the college application where I decided to apply to Educational Opportunity Program (EOP). Soon after, I got accepted. Additionally, while I was still finishing my high school senior year I received another email to apply for the Mathematics, Engineering, Science Achievement (MESA) program.
