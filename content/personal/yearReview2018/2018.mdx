...
<Gallery columns={3} photos={[
   { src: party1, width: 33, height: 28 },
   { src: party2, width: 33, height: 28 },
   { src: party3, width: 33, height: 28 },
   { src: party4, width: 33, height: 28 },
   { src: party5, width: 33, height: 28 },
   { src: party6, width: 33, height: 28 },
]} />

<Gallery columns={1} photos={[
   { src: party7, width: 100, height: 75 },
]} />

<Gallery columns={3} photos={[
   { src: party8, width: 33, height: 45 },
   { src: party9, width: 33, height: 45 },
   { src: party10, width: 33, height: 45 },
   { src: party11, width: 33, height: 45 },
   { src: party12, width: 33, height: 45 },
   { src: party13, width: 33, height: 45 },
   { src: party14, width: 33, height: 28 },
   { src: party15, width: 33, height: 28 },
   { src: party16, width: 33, height: 28 },
]} />
...
<Gallery columns={3} photos={[
   { src: party17, width: 33, height: 28 },
   { src: party18, width: 33, height: 28 },
   { src: party19, width: 33, height: 28 },
]} />
...
<Gallery photos={[
   { src: back1, width: 40, height: 30 },
   { src: back2, width: 60, height: 30 },
]} />
...
<Gallery photos={[
   { src: back3, width: 50, height: 25 },
   { src: back4, width: 50, height: 25 },
]} />
...
<Gallery photos={[
   { src: back5, width: 50, height: 28 },
   { src: back6, width: 50, height: 28 },
]} />
...
<Gallery columns={1} photos={[
   { src: friends, width: 100, height: 75 },
]} />
