        ...
        <Card style={cardStyle}>
          ...
          {/\/[aA]bout\/$/.test(this.state.value) && <CardContent>
            <p>
              ...
              In 2008, we moved to Turkey, where we applied to be refugees in the United States through the United Nations.
              Within nine months, we were granted visas to the US.
            </p>
            <br/>
            <p>
              When I first landed in the US, I knew that I had the opportunity to accomplish all my goals and make my dreams a reality.
              Nonetheless, it was not easy. Starting with learning the language and culture, to catching up and passing my peers.
              I started high school as a sophomore, with no records to account for the first year and a half of my high school career.
            ...
            <p>
              ...
              During my time at SDSU, I not only got to expand my knowledge and skill sets; but I also got to meet great people, who have left a great impact on my life and future.
              ...
              This led to me meeting other great entrepreneurial people with whom I started CourseKey.
            </p>
            <br/>
            <p>
          ...
          {/\/[aA]bout\/[sS]oftwareDevelopment/.test(value) && <CardContent>
            ...
            <p>
              ...
              The teenage me went headfirst into gaming. Nonetheless, my curiosity still got the best of me.
              It started with modding game files to get the premium characters at first.
              Then I transitioned to adding my own models, customizations skins, maps, and other game files.
            ...
            <p>
              ...
              Playing around with a server led me to a whole new world.
            </p>
            <br/>
            <p>
              ...
              I learned the differences between compiled and run-time languages, understood client-server communication, then dove deeper into networking, how TCP works. At this point, I was a freshman in the university.
            ...
            <br/>
            <p>
              I took the knowledge I gained up to that point and applied it into my classes.
            ...
            <p>
              ...
              All that meant for me was that I had more free time to experiment with different things.
              ...
              I even turned it into a gaming console, media center, and a remote admin shell.
            ...
            <p>
              ...
              I created many apps over the years. Some I forgot about, some provided great value for me and others, some got me in trouble and some that just satisfied my curiosity.
          ...
          {/\/[aA]bout\/[eE]ducation/.test(value) && <CardContent>
            <p>
              For me, education is an ongoing process. Since early on, I always was interested in learning, learning about everything from how history shaped our current societies to how atoms work.
            ...
            <p>
              ...
              That was not easy! It was the hardest thing I had done, I spend my entire summer studying and preparing for it.
            ...
            <br />
            <p>
              When I came to the US, I was a sophomore. That meant that I had missed on a year and a half of academic progress.
